...
for simInd in range(nrSimRunsStart, nrSimRunsStop):
  ...
  parFile=open(os.path.join(destPath, "insRateMain.pckl"),"rb"); insRateMain=pickle.load(parFile); parFile.close()
  ...
  openInitArr.append(openInit)
  openMainArr.append(openMain)
  ...
  insRateMainArr.append(insRateMain)
...
"openInit":  openInitArr,
"openMain":  openMainArr,
