...
templateGitDir=os.path.join(simGitDir, "templates", "drum", "vi")
...
crInitPar=[[[0.7, 0.7, 0.7],
            [0.7, 0.7, 0.7],
            [0.7, 0.7, 0.7]]]
crMainPar=[[[0.7, 0.7, 0.7],
            [0.7, 0.7, 0.7],
            [0.7, 0.7, 0.7]]]
#crMainPar=copy.deepcopy(crInitPar)
cfInitPar=[[[0.35, 0.35, 0.35],
            [0.35, 0.35, 0.35],
            [0.35, 0.35, 0.35]]]
cfMainPar=[[[0.35, 0.35, 0.35],
            [0.35, 0.35, 0.35],
            [0.35, 0.35, 0.35]]]
#cfMainPar=copy.deepcopy(crInitPar)
crfInitPar=[[[0.05, 0.05, 0.05],
             [0.05, 0.05, 0.05],
             [0.05, 0.05, 0.05]]]
...
radMainPar=[[None, [[1e-2, 1e-2], [1e-2, 1e-2]], [[1e-2, 1e-2], [1e-2, 1e-2]]]]
insRateInitPar=[1000]
insRateMainPar=[1000]
...
for simInd in range(nrSimRunsStart, nrSimRunsStop):
  ...
  insRateMainInd=hyperparInd[hyperparName["insRateMain"]][0]; insRateMain=insRateMainPar[insRateMainInd]
  ...
  parFile=open(os.path.join(destPath, "insRateMain.pckl"),"wb"); pickle.dump(insRateMain, parFile); parFile.close()
