...
for simInd in range(nrSimRunsStart, nrSimRunsStop):
  ...
  scaleRadiusArr.append(scaleRadius)
  scaleLengthArr.append(scaleLength)
  nrParticles1Arr.append(nrParticles1)
  nrParticles2Arr.append(nrParticles2)
...
"scaleRadius": scaleRadiusArr,
"scaleLength": scaleLengthArr,
