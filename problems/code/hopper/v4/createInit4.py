...
#holeSizeLower=[1.0/3.0]
#holeSizeUpper=[2.0/3.0]
#holeSizeLower=[2.0/3.0]
#holeSizeUpper=[1.0]
holeSizeLower=[0.8/1.5] #..., starting from 0.8, such that numbers between bottomResizeLower and bottomResizeUpper get valid ==> >=min
holeSizeUpper=[1.0]
bottomResizeLower=[0.8] #devided by holeSize
bottomResizeUpper=[1.2] #devided by holeSize
