...
for simInd in range(nrSimRunsStart, nrSimRunsStop):
  ...
  writeState(destPath+"/init.data", regionX0, regionX1, regionY0, regionY1, regionZ0, regionZ1, id_DataNew, x_DataNew, v_DataNew, omegaDataNew, radius_Data[cut], type_Data[cut], density_Data[cut], nrAtomTypes)
