...
if not restart:
  ...
  saveName="d"+str(contNr)+"_"+str(int(time.time()*1000.0))+"_"+datetime.date.today().strftime("%d-%m-%Y")+"_hopper2Ab2"
  if args.addInfo!="":
...
assert(rp["version"]=="processHopper2Ab2")
