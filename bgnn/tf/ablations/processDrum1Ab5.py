...
rp["multAngle"]=0.0
rp["gravBias"]=False
rp["model"]="modelDrum1.py"
rp["confFile"]="confDrum1.py"
...
if not restart:
  ...
  rp["networkPar"]["nrSteps"]=10
  rp["networkPar"]["inputPar"]["nodep"]["layerSz"]=[128, 512]
  rp["networkPar"]["inputPar"]["edgep"]["layerSz"]=[128, 512]
  rp["networkPar"]["processPar"]["nodep"]["layerSz"]=[512, 512]
  rp["networkPar"]["processPar"]["edgep"]["layerSz"]=[512, 512]
  ...
  saveName="d"+str(contNr)+"_"+str(int(time.time()*1000.0))+"_"+datetime.date.today().strftime("%d-%m-%Y")+"_drum1Ab3"
  if args.addInfo!="":
...
assert(rp["version"]=="processDrum1Ab3")
#rp["problem"]=args.problem
#rp["experiment"]=args.experiment
#rp["version"]="processDrum1"
#rp["model"]="modelDrum1.py"
#rp["confFile"]="confDrum1.py"
