...
if not restart:
  ...
  saveName="d"+str(contNr)+"_"+str(int(time.time()*1000.0))+"_"+datetime.date.today().strftime("%d-%m-%Y")+"_hopper1Ab3"
  if args.addInfo!="":
...
assert(rp["version"]=="processHopper1Ab3")
