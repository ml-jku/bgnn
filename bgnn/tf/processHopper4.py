...
rp["multAngle"]=0.0
rp["gravBias"]=False
rp["model"]="modelHopper4.py"
rp["confFile"]="confHopper4.py"
...
if not restart:
  ...
  saveName="d"+str(contNr)+"_"+str(int(time.time()*1000.0))+"_"+datetime.date.today().strftime("%d-%m-%Y")+"_hopper2"
  if args.addInfo!="":
...
assert(rp["version"]=="processHopper4")
