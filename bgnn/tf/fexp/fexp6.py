...
parser.add_argument("-saveName", help="", type=str, default="fexp6")
parser.add_argument("-addInfo", help="", type=str, default="")
parser.add_argument("-problem", help="", type=str, default="hopper")
parser.add_argument("-experiment", help="", type=str, default="runs0")
...
rp["useInvDist2Len"]=(True,(2,2,1,0))
rp["useInvDist2Vec"]=(True,(2,2,1,0))
...
rp["multAngle"]=0.0
rp["gravBias"]=False
rp["model"]="modelHopper0.py"
rp["confFile"]="confHopper0.py"
...
if not restart:
  ...
  saveName="d"+str(contNr)+"_"+str(int(time.time()*1000.0))+"_"+datetime.date.today().strftime("%d-%m-%Y")+"_hopper0"
  if args.addInfo!="":
