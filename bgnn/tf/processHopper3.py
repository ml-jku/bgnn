...
parser.add_argument("-experiment", help="", type=str, default="runs3")
...
rp["multAngle"]=0.0
rp["gravBias"]=False
rp["model"]="modelHopper3.py"
rp["confFile"]="confHopper3.py"
...
assert(rp["version"]=="processHopper3")
