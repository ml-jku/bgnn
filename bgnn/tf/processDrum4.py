...
parser.add_argument("-experiment", help="", type=str, default="runs4")
...
rp["multAngle"]=0.0
rp["gravBias"]=False
rp["model"]="modelDrum4.py"
rp["confFile"]="confDrum4.py"
...
assert(rp["version"]=="processDrum4")
