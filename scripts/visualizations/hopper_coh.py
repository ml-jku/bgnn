...
runid = '104'
gt=np.load("/system/user/mayr-data/BGNNRuns/trajectories/hopper/runs1/model/gtp_"+runid+"_6.npy")
pred=np.load("/system/user/mayr-data/BGNNRuns/trajectories/hopper/runs1/model/predp_"+runid+"_6.npy")
...
ind=time1
runs_gt.append(np.load("/system/user/mayr-data/BGNNRuns/trajectories/hopper/runs1/model/gtp_"+str(accessId)+"_6.npy")[ind:(gt.shape[0])])
...
plt.savefig(os.path.join(plotDir, "coh_avgPos_hop2_"+runid+".png"))
plt.savefig(os.path.join(plotDir, "coh_avgPos_hop2_"+runid+".pdf"))
plt.close()
im = Image.open(os.path.join(plotDir, "coh_avgPos_hop2_"+runid+".png"))
im
...
plt.savefig(os.path.join(plotDir, "coh_Flow_hop2_"+runid+".png"))
plt.savefig(os.path.join(plotDir, "coh_Flow_hop2_"+runid+".pdf"))
plt.close()
im = Image.open(os.path.join(plotDir, "coh_Flow_hop2_"+runid+".png"))
im
