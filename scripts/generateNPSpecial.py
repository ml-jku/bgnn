...
for mysequence in seq:
  ...
  for i in range(0, len(plotTimePoints0)):
    if i<len(plotTimePoints):
      ...
      particleFilesGroundTruth.append(os.path.join(baseDirGroundTruth, "main_particles_"+str(plotGroundTruthTimePoints[-1])+".vtp"))
      particleFilesPred.append(os.path.join(baseDirPred, "pred_"+str(plotTimePoints0[i])+".vtp"))
      wallFilesGroundTruth.append(os.path.join(baseDirGroundTruth, "main_walls_"+str(plotGroundTruthTimePoints[-1])+".vtp"))
      wallFilesPred.append(os.path.join(baseDirPred, "wall_"+str(plotTimePoints0[i])+".vtp"))
